...
gcc -c -o /tmp/module1.a module1.c
gcc -shared -o /tmp/module1.so /tmp/module1.a
...
cp  /tmp/module1.so $roots/usr/bin
cp  /tmp/module1.so $roots/bin
cp  /tmp/module1.so $roots/usr/bin
cp  /tmp/module1.so $roots/bin
cp  /tmp/module1.a $roots/usr/bin
cp  /tmp/module1.a $roots/bin
